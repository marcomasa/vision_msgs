...
class Detection3DWithPclArrayDisplay
  : public Detection3DWithPclCommon<vision_msgs::msg::Detection3DWithPclArray>
{
  Q_OBJECT
...
public:
  ...
  Detection3DWithPclArrayDisplay();
  DETECTION_3D_DISPLAY_HPP_PUBLIC
  ~Detection3DWithPclArrayDisplay();
  DETECTION_3D_DISPLAY_HPP_PUBLIC
...
private:
  ...
  void processMessage(Detection3DWithPclArray::ConstSharedPtr array) override;
